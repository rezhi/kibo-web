		...
		<div class="js-fullheight fh5co-table">
			<div class="fh5co-table-cell js-fullheight">
				<ul>
					...
					<li class="active"><a href="artikel_rawat.php">INFO PERAWATAN</a></li>
...
<h1 style="color:#16a085; font-family:bernard mt condensed; font-size: 200%;" class="intro-heading"><marquee>INFO PERAWATAN BURUNG KICAU</marquee></h1>
<center><p><i>Informasi terlengkap dan terakurat mengenai cara perawatan burung kicau dari mulai pemberian pakan dan pemandian burung.</i></p></center>
<div class="row">
  <div class="column">
    <div class="content">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-left">
						...
						<?php
include "koneksi.php";
$has = "SELECT * FROM rawat order by tgl_artikel desc";
...
while($data=mysqli_fetch_array($hasil)){
	$art = substr($data['isi_artikel'],0,100);
	 echo '
	 				<table width="100%" >
					<tr>
					<th colspan="2"><h2 style="color:#2c3e50; font-family:bernard mt condensed; font-size: 230%;" class="intro-heading" >'.$data['judul_artikel'].'</h2></th>
					</tr>
					<tr>
					<td><img width="350" height="200" src="photo-artikel/'.$data['photo_artikel'].'"></td>
					<td><i>Di publikasikan pada '.$data['tgl_artikel'].'
					,Oleh '.$data['penulis_artikel'].'</i><br>
					'.$art.'..<br>
				    <a href="single_rawat.php?p='.$data['id_artikel'].'">Selengkapnya</a></td>
					<br><br>
</table>
