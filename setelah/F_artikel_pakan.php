...
<body>
	<header>
	<center><h1 class="mt-4 mb-3" style=" font-family:bernard mt condensed; font-size: 250%; color: white;">BUAT ARTIKEL </h1></center>
</header><hr>
<artikel>
<form id="formberita" method="post" action="save_pakan.php" enctype="multipart/form-data">
...
<hr><CENTER>
		<input style="background-color:#2c3e50;font-family:bernard mt condensed; font-size:150%; color: white;   " type="submit" id="submit" value="Kirim">
		 <a href="/kibo/setelah/tabel_pakan.php"><input style="background-color:#2c3e50; font-family:bernard mt condensed; font-size:150%; color: white;   " type="button" value="Batal"></a></CENTER>
