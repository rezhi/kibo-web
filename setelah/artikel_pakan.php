		...
		<div class="js-fullheight fh5co-table">
			<div class="fh5co-table-cell js-fullheight">
				<ul>
					...
					<li class="active"><a href="artikel_pakan.php">JENIS PAKAN</a></li>
...
<h1 style="color:#16a085; font-family:bernard mt condensed; font-size: 200%;" class="intro-heading"><marquee>JENIS PAKAN BURUNG KICAU</marquee></h1>
<center><p><i>Jenis pakan burung terbagi menjadi 2, yaitu pakan hewani dan pakan nabati. Berbagai artikel dibawah menjelaskan tentang manfaat dan khasiat dari pakan hewani dan pakan nabati.</i></p></center>
<div class="row">
  <div class="column">
    <div class="content">
      <img  src="lovebird/1.jpg" width="100%"  alt="">
 ...
 <div class="column">
    <div class="content">
      <img  src="lovebird/2.jpg" width="100%"  alt="">
 ...
 <div class="column">
    <div class="content">
      <img src="lovebird/3.jpg" width="100%"  alt="">
  ...
  <div class="column">
    <div class="content">
      <img src="lovebird/4.jpg" width="100%"  alt="">
	...
	<div id="fh5co-intro-section">
			<div class="container">
				...
				<div class="col-md-12 text-left">
						...
						<?php
include "koneksi.php";
$has = "SELECT * FROM pakan order by tgl_artikel desc";
...
while($data=mysqli_fetch_array($hasil)){
	$art = substr($data['isi_artikel'],0,200);
	 echo '
	 			
					<h2 style="color:#2c3e50; font-family:bernard mt condensed; font-size: 230%;" class="intro-heading" >'.$data['judul_artikel'].'</h2>
					<img width="500" height="300" src="photo-artikel/'.$data['photo_artikel'].'"><br><br>
					<h4 ><i>Di publikasikan pada '.$data['tgl_artikel'].'
					, Oleh '.$data['penulis_artikel'].'</i></h4>
					<p >'.$art.'..
				    <a href="single_pakan.php?p='.$data['id_artikel'].'">Selengkapnya</a></p>
					<br><br>
