...
<hr><CENTER>
		<input style="background-color:#2c3e50;font-family:bernard mt condensed; font-size:150%; color: white;  " type="submit" id="submit" value="Kirim">
		 <a href="/kibo/setelah/tabel.php"><input style="background-color:#2c3e50; font-family:bernard mt condensed; font-size:150%; color: white;  " type="button" value="Batal"></a></CENTER>
