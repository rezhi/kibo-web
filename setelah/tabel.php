...
<body >
 ...
 <a href="formartikel.php"><input style="background-color:#16a085; color: white; font-family:bernard mt condensed; font-size:150%;  " type="button" value="Tambah Data"></a> <br><br>
...
<artikel>
  ...
  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><a href='hapus.php?id=".$data['id_artikel']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
  </table>
